package com.honggv.flutter_rtmp_live_plugin.util;
...
public class CommonUtil {
    ...
    public static void runMainThreadReturn(final MethodChannel.Result result, final Object param) {
        Log.d(RtmpPushPlatformView.class.getName(), "run: 准备进入连麦线程");
        MAIN_HANDLER.post(new Runnable() {
            @Override
            public void run() {
                Log.d(RtmpPushPlatformView.class.getName(), "run: 进入连麦线程");

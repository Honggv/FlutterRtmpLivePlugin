...
import 'package:flutter_rtmp_live_plugin/enums/rtmp_push_audio_quality_enum.dart';
import 'package:flutter_rtmp_live_plugin/enums/rtmp_push_video_quality_enum.dart';
...
class StreamingProfileEntity {
  ...
  /// 视频质量
  RtmpPushVideoQualityEnum videoQuality;

  /// 音频质量
  RtmpPushAudioQualityEnum audioQuality;
  ...
  StreamingProfileEntity({
    this.publishUrl,
    this.videoQuality: RtmpPushVideoQualityEnum.VIDEO_QUALITY_HIGH3,
  ...
  Map<String, dynamic> toJson() {
    ...
    data["videoQuality"] = this.videoQuality == null
        ? null
        : RtmpPushVideoQualityEnumTool.toInt(this.videoQuality);
    data["audioQuality"] = this.audioQuality == null
        ? null
        : RtmpPushAudioQualityTool.toInt(this.audioQuality);
